...
%numerical solver (this is for No Interaction)

function init=input_initial_general_for_arg_4(default)

%Define initial conditions (A(0),a(0), C(0), b(0))
...
init=[A_init, a_init, C_init, b_init];
end